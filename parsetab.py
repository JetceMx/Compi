...
_lr_productions = [
  ...
  ('declaration_list -> ID','declaration_list',1,'p_declaration_list','main.py',121),
  ('declaration_list -> declaration_list COMMA ID','declaration_list',3,'p_declaration_list','main.py',122),
  ('type -> INT','type',1,'p_type','main.py',129),
  ('type -> FLOAT','type',1,'p_type','main.py',130),
  ('type -> BOOL','type',1,'p_type','main.py',131),
  ('statements -> statements statement','statements',2,'p_statements','main.py',135),
  ('statements -> empty','statements',1,'p_statements','main.py',136),
  ('statement -> WRITE expression SEMI','statement',3,'p_statement','main.py',143),
  ('statement -> READ ID SEMI','statement',3,'p_statement','main.py',144),
  ('statement -> IF expression THEN LBRACE statements RBRACE ELSE LBRACE statements RBRACE END','statement',11,'p_statement','main.py',145),
  ('statement -> DO LBRACE statements RBRACE UNTIL LPAREN expression RPAREN SEMI','statement',9,'p_statement','main.py',146),
  ('statement -> WHILE LPAREN expression RPAREN LBRACE statements RBRACE','statement',7,'p_statement','main.py',147),
  ('statement -> ID ASSIGN expression SEMI','statement',4,'p_statement','main.py',148),
  ('expression -> expression PLUS term','expression',3,'p_expression','main.py',163),
  ('expression -> expression MINUS term','expression',3,'p_expression','main.py',164),
  ('expression -> expression LT term','expression',3,'p_expression','main.py',165),
  ('expression -> expression LE term','expression',3,'p_expression','main.py',166),
  ('expression -> expression GT term','expression',3,'p_expression','main.py',167),
  ('expression -> expression GE term','expression',3,'p_expression','main.py',168),
  ('expression -> expression EQ term','expression',3,'p_expression','main.py',169),
  ('expression -> expression NEQ term','expression',3,'p_expression','main.py',170),
  ('expression -> expression AND term','expression',3,'p_expression','main.py',171),
  ('expression -> expression OR term','expression',3,'p_expression','main.py',172),
  ('expression -> term','expression',1,'p_expression','main.py',173),
  ('term -> term EXPONENT factor','term',3,'p_term','main.py',180),
  ('term -> term TIMES factor','term',3,'p_term','main.py',181),
  ('term -> term DIVIDE factor','term',3,'p_term','main.py',182),
  ('term -> factor','term',1,'p_term','main.py',183),
  ('factor -> NUMBER','factor',1,'p_factor','main.py',200),
  ('factor -> ID','factor',1,'p_factor','main.py',201),
  ('factor -> TRUE','factor',1,'p_factor','main.py',202),
  ('factor -> FALSE','factor',1,'p_factor','main.py',203),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','main.py',204),
